...
const content: DesignEraMap = {
	...
	[designEras.flatDesign]: `Le milieu des années 2000 est un période contrasté pour le webdesign, quand une partie du web se lâche dans une créativité sans aucune limite (y compris celle du bon goût) avec Adobe Flash, les grands services web qui explosent et qui finiront par dominer la décennie suivante imposent un design minimaliste et très peu inspiré, motivé par la simplicité d'utilisation et la rapidité de chargement à une époque ou le haut débit n'est absolument pas la norme. De plus, alors que tous les services restent à construire dans un web en cours d'adoption, que l'Iphone n'est encore qu'en projet, le design n'est absolument pas la priorité d'équipes composées principalement d'ingénieurs très techniques.`,
	[designEras.material]: `L'année 2009 est une année commune qui commence un jeudi. C'est la 2009e année de notre ère, la 9e année du IIIe millénaire et du xxie siècle et la 10e et dernière année de la décennie 2000-2009. 2009 a été déclarée Année mondiale de l'astronomie (décision de l'Assemblée générale des Nations unies en date du 19 décembre 2007). Ceci célèbre Galilée qui, il y a 400 ans, a pointé une lunette vers le ciel. Cela lui a permis de découvrir les quatre principaux satellites de Jupiter, les montagnes et cratères de la Lune et les taches solaires. `,
	[designEras.brutalism]: `Le milieu des années 2000 est un période contrasté pour le webdesign, quand une partie du web se lâche dans une créativité sans aucune limite (y compris celle du bon goût) avec Adobe Flash, les grands services web qui explosent et qui finiront par dominer la décennie suivante imposent un design minimaliste et très peu inspiré, motivé par la simplicité d'utilisation et la rapidité de chargement à une époque ou le haut débit n'est absolument pas la norme. De plus, alors que tous les services restent à construire dans un web en cours d'adoption, que l'Iphone n'est encore qu'en projet, le design n'est absolument pas la priorité d'équipes composées principalement d'ingénieurs très techniques.`,
	[designEras.now]: `Le milieu des années 2000 est un période contrasté pour le webdesign, quand une partie du web se lâche dans une créativité sans aucune limite (y compris celle du bon goût) avec Adobe Flash, les grands services web qui explosent et qui finiront par dominer la décennie suivante imposent un design minimaliste et très peu inspiré, motivé par la simplicité d'utilisation et la rapidité de chargement à une époque ou le haut débit n'est absolument pas la norme. De plus, alors que tous les services restent à construire dans un web en cours d'adoption, que l'Iphone n'est encore qu'en projet, le design n'est absolument pas la priorité d'équipes composées principalement d'ingénieurs très techniques.`,
};
